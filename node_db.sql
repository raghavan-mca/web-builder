...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2022 at 06:47 PM
...
--
-- Table structure for table `aristostech_template_count`
--

CREATE TABLE `aristostech_template_count` (
  `id` int(11) NOT NULL,
  `uid` varchar(100) NOT NULL,
  `template_name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indexes for table `aristostech_template_count`
--
ALTER TABLE `aristostech_template_count`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `aristostech_template_count`
--
ALTER TABLE `aristostech_template_count`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
